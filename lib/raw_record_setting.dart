...
class _NDEFRecordSetting extends State<NDEFRecordSetting> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text('Set Record')),
        body: Center(
          child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  DropdownButton(
                    ...
                    items: [
                      DropdownMenuItem(child: Text('empty'), value: 0),
                      DropdownMenuItem(child: Text('nfcWellKnown'), value: 1),
                      DropdownMenuItem(child: Text('media'), value: 2),
                      DropdownMenuItem(child: Text('absoluteURI'), value: 3),
                      DropdownMenuItem(child: Text('nfcExternal'), value: 4),
                      DropdownMenuItem(child: Text('unchanged'), value: 5),
                      DropdownMenuItem(child: Text('unknown'), value: 6),
                    ],
                    onChanged: (value) {
                      setState(() {
